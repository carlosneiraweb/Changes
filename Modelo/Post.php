...
class Post extends DataObj{
    ...
    * 
    ...
    private function devuelvoIdPalabras($tabla, $columnaIdImagen,$columnaIdPost, $idPostPalabra){
         ...
         try {
            ...
            $con = Conne::connect();
                            ...
                            $stm->execute();
                            $misPalabras = $stm->fetchAll(PDO::FETCH_COLUMN, 0);
    ...
    */
    ...
    private function actualizarPalabrasBuscadas($idPostPalabras){
        ...
        try {
            ...
            $buscadas =  $this->devuelvoIdPalabras("busquedas_pbs_buscadas", "idPbsBuscada", "idPost_queridas", $idPostPa);
            ...
            $nuevasPalabras = $this->getValue('Pa_queridas');
                ...
                for($i = 0; $i < 4; $i++){
                        ...
                        $stm = " UPDATE ".TBL_PBS_QUERIDAS. " SET palabrasBuscadas =". "'$nuevasPalabras[$i]'"." WHERE idPbsBuscada = "."'$buscadas[$i]'"." and idPost_queridas = ".$idPostPa.";";
                        $stm = $con->prepare($stm);
    ...
    private function actualizarPalarasOfrecidas($idPostPalabras){
        ...
        //El id de las viejas palabras
            $ofrecidas= $this->devuelvoIdPalabras("busquedas_pbs_ofrecidas", "idPbsOfrecida", "idPost_ofrecidas", $idPostOfre);
        ...
        try {
            ...
            $con = Conne::connect();
                ...
                for($i = 0; $i < 4; $i++){
                        ...
                        $stm = " UPDATE ".TBL_PBS_OFRECIDAS. " SET palabrasOfrecidas =". "'$nuevasOfrecidas[$i]'"." WHERE idPbsOfrecida = "."'$ofrecidas[$i]'"." and idPost_ofrecidas = ".$idPostOfre.";";
                        $stm = $con->prepare($stm);
